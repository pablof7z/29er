...
# ios/29er/Vendor/NmpCore.xcframework.
#
# 29er links one aggregate Rust archive (`-lnmp_app_29er`) that contains
# nmp-core, nmp-native-runtime, and the 29er per-app UniFFI facade (the
# hand-written `nmp-ffi` C-ABI crate is deleted, see #2494). UniFFI Swift
...
# (e.g. `NmpCore.xcframework/ios-arm64-simulator/libnmp_app_29er.a`), which
