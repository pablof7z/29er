//! Content tokenization exposed through the 29er UniFFI namespace.
//!
//! The shell asks for a render tree; `nmp-content` owns parsing, entity
//! tokenization, markdown mode selection, and emoji-tag interpretation.
